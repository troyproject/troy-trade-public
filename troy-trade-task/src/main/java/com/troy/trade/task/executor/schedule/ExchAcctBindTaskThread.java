 ...
 * @author dp
 */
public class ExchAcctBindTaskThread extends Thread {
    private AccountBindModel accountModel;
    ...
    public void run() {
        ...
        taskService.syncAccountBindThirdOrderStatusJob(accountModel);
    }

    public AccountBindModel getAccountModel() {
        return accountModel;
    }

    public void setAccountModel(AccountBindModel accountModel) {
