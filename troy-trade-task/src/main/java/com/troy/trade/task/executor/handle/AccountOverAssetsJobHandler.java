 ...
 */
@Slf4j
@JobHandler(value="accountOverAssets")
@Component
public class AccountOverAssetsJobHandler extends IJobHandler {
    ...
    public ReturnT<String> execute(String s) throws Exception {
        log.info("超额资产 增量更新开始---------------当前时间" + DateUtils.formatDate(new Date(), DateUtils.FORMAT_DATE_TIME));
        syncOrderInfoScheduledUtil.synUpdateOverAssets();
        return SUCCESS;
    }
}
